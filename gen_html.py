        ...
        <div class="gear-content">
            ...
            <div class="gear-image-stack">
                <div class="gear-image">
                    <img src="mes photos/IMG_5644.jpg" alt="Appareils SOGCLIPS">
                </div>
                <div class="gear-image">
                    <img src="gear.jpg" alt="Matériel Vidéo Professionnel SOGCLIPS">
                </div>
            </div>
        </div>
    </section>
...
html_template += """    </section>
    ...
    <section class="about" id="about">
        <div class="about-portrait">
            <img src="mes photos/IMG_5647.jpg" alt="Sogclips — Reel Maker">
        </div>
    ...
    <footer class="footer" id="contact">
        <div class="footer-inner">
            ...
            <div class="footer-contact-links">
                <a href="https://wa.me/2250749013665" class="footer-link" target="_blank">
                ...
                <a href="https://www.tiktok.com/@directedbysog?_r=1&_t=ZS-94zi1wFzHz2" class="footer-link" target="_blank">
                    <i class="fa-brands fa-tiktok"></i>
                    TikTok
                </a>
                <a href="https://www.instagram.com/directedbysog?igsh=cmowdmYzNnhoZ2xw" class="footer-link" target="_blank">
                    <i class="fa-brands fa-instagram"></i>
                    Instagram
                </a>
                <a href="https://www.facebook.com/share/1Ai8vc6mgc/?mibextid=wwXIfr" class="footer-link" target="_blank">
    ...
    <div class="social-float-container">
        <a href="https://www.facebook.com/share/1Ai8vc6mgc/?mibextid=wwXIfr" class="social-float facebook" target="_blank" aria-label="Facebook">
            <i class="fa-brands fa-facebook-f"></i>
            <span class="social-tooltip">Facebook</span>
        </a>
        <a href="https://www.instagram.com/directedbysog?igsh=cmowdmYzNnhoZ2xw" class="social-float instagram" target="_blank" aria-label="Instagram">
            <i class="fa-brands fa-instagram"></i>
            <span class="social-tooltip">Instagram</span>
        </a>
        <a href="https://www.tiktok.com/@directedbysog?_r=1&_t=ZS-94zi1wFzHz2" class="social-float tiktok" target="_blank" aria-label="TikTok">
            <i class="fa-brands fa-tiktok"></i>
            <span class="social-tooltip">TikTok</span>
        </a>
        <a href="https://wa.me/2250749013665" class="social-float whatsapp" target="_blank" aria-label="WhatsApp">
            <i class="fa-brands fa-whatsapp"></i>
